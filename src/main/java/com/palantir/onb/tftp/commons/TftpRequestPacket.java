...
/**
 * An abstract class derived from TFTPPacket defining a TFTP Request
...
public abstract class TftpRequestPacket extends TftpPacket {
     ...
     * the class.  Under normal circumstances, you should not have a need to call
     * this method.
     *
    ...
    public final DatagramPacket newDatagram() {
        ...
        data[0] = 0;
        data[1] = (byte) getType();
        System.arraycopy(fileName.getBytes(StandardCharsets.UTF_8), 0, data, 2, fileLength);
        data[fileLength + 2] = 0;
