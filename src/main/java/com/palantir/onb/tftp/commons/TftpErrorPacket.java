...
/**
 * A final class derived from TFTPPacket defining the TFTP Error
 * packet type.
 * <p>
...
public final class TftpErrorPacket extends TftpPacket {
     ...
     * the TFTPClient class. Under normal circumstances, you
     * should not have a need to call this method.
     *
    ...
    public DatagramPacket newDatagram() {
        ...
        System.arraycopy(message.getBytes(StandardCharsets.UTF_8), 0, data, 4, length);
