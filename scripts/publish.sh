...
echo Publishing to ${URL} from ${CACHE_DIR}/onb-classic.jar
curl --silent --show-error --fail --user "${ARTIFACTORY_USERNAME}:${ARTIFACTORY_PASSWORD}" --request PUT ${URL} --upload-file ${CACHE_DIR}/onb-classic.jar
